...
mhdp <- mhdp %>%
  mutate(across(c(
    ...
    co_curricular, sports, perceived_academic_abilities, age, home,
...
print(table(mhdp$study_name, mhdp$timepoint, useNA = "ifany"))
print(table(mhdp$study_name, mhdp$school_county, useNA = "ifany"))
